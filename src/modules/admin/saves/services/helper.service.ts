...
export class HelperService extends BaseHelperService {
  ...
  private repository = this.prisma.save;
  ...
  async create(props: IProps, data: TCreateRequest): Promise<IDefault> {
    ...
    const record = await this.repository.create({
      data: {
        ...
        userId: data.userId,
        mediaComponentId: data.mediaComponentId,
        mediaComponentIn: data.mediaComponentIn,
        status: data.status,
      },
    });
  ...
  async list(
    ...
    const listed = await this.listing<R, F, W, S, O>(this.repository, data, {
      ...
      searchableFields: {
        ...
        mediaComponentId: EFieldType.STRING,
      ...
      select: {
        ...
        mediaId: true,
        userId: true,
        mediaComponentId: true,
        mediaComponentIn: true,
        status: true,
        createdAt: true,
      },
    });
